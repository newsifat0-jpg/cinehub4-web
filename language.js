...
window.CINEHUB4_LANG = (() => {
  ...
  const DICT = {
    ...
    "Close": "বন্ধ",
    "Copy Link": "লিংক কপি",
    "Ad loading…": "অ্যাড লোড হচ্ছে…",
    "Ad failed to load. Try again.": "অ্যাড লোড হয়নি। আবার চেষ্টা করুন।",
    "Ad was not completed. Try again.": "অ্যাড সম্পূর্ণ দেখা হয়নি। আবার চেষ্টা করুন।",
    "Please try again after": "এর পর আবার চেষ্টা করুন",
    " second(s)": " সেকেন্ড",
    " minute(s)": " মিনিট",
    ...
    "ADULT CONTENT": "অ্যাডাল্ট কনটেন্ট",
    "Unlock this content using ads or points.": "এই কনটেন্টটি ads অথবা points ব্যবহার করে আনলক করুন।",
    "Required": "প্রয়োজন",
    "Need": "প্রয়োজন",
    "My Points": "আমার পয়েন্ট",
    "Remaining": "বাকি",
    "Progress": "প্রোগ্রেস",
    "Ads needed": "Ads প্রয়োজন",
    "Unlock duration": "আনলক সময়",
    "Unlock with points or ads": "পয়েন্ট অথবা ads দিয়ে আনলক করুন।",
    "Unlock Video": "ভিডিও আনলক করুন",
    "Use My Points": "আমার পয়েন্ট ব্যবহার করুন",
    "Content unlocked.": "কনটেন্ট আনলক হয়েছে।",
    "Content unlocked successfully": "কনটেন্ট সফলভাবে আনলক হয়েছে",
    "Unlock time remaining": "আনলকের সময় শেষ হতে বাকি",
    "This content stays unlocked for a limited time.": "এই কনটেন্টটি নির্দিষ্ট সময় পর্যন্ত আনলক থাকবে।",
    "Download Now": "এখনই ডাউনলোড করুন",
    "Watch or download": "দেখুন বা ডাউনলোড করুন",
    "Download / Watch": "ডাউনলোড / দেখুন",
    "Likes": "লাইক",
    "Views": "ভিউ",
    "Already unlocked": "ইতিমধ্যে আনলক করা",
    ...
    "Choose wallet": "ওয়ালেট বেছে নিন",
    "Wallet": "ওয়ালেট",
    "Wallet address will appear here.": "ওয়ালেট অ্যাড্রেস এখানে দেখা যাবে।",
    "Send the exact USDT amount to the selected address. Then submit your TxID and payment screenshot below.": "নির্বাচিত অ্যাড্রেসে সঠিক USDT পাঠান। তারপর নিচে TxID ও পেমেন্ট স্ক্রিনশট জমা দিন।",
    "Paste your transaction hash / TxID here": "এখানে ট্রানজেকশন হ্যাশ / TxID পেস্ট করুন",
    "Payment Screenshot": "পেমেন্ট স্ক্রিনশট",
    "Please select a payment method / wallet": "পেমেন্ট মেথড / ওয়ালেট সিলেক্ট করুন",
    "Please enter Transaction ID / TxID": "ট্রানজেকশন আইডি / TxID লিখুন",
    "Please wait…": "অপেক্ষা করুন…",
    "Submitting…": "জমা হচ্ছে…",
    "Ad progress": "অ্যাড প্রোগ্রেস",
    "Welcome via referral": "রেফারেল দিয়ে স্বাগতম",
    "Task": "টাস্ক",
    "Share your link — points when friends join": "লিংক শেয়ার করুন — বন্ধু জয়েন করলে পয়েন্ট",
    "Paste full ad URL for this network": "এই নেটওয়ার্কের সম্পূর্ণ অ্যাড URL পেস্ট করুন",
    "Open the link, then tap Claim. Cancel = no points.": "লিংক খুলুন, তারপর Claim চাপুন। Cancel = পয়েন্ট নেই।",
    "Open a movie first": "আগে একটি মুভি খুলুন",
    "Open Link": "লিংক খুলুন",
    "Link not set": "লিংক সেট নেই",
    "Join the channel first": "আগে চ্যানেলে জয়েন করুন",
    "Join channel then tap Start again": "চ্যানেলে জয়েন করে আবার Start চাপুন",
    "Could not verify": "যাচাই করা যায়নি",
    "Claim": "ক্লেইম",
    "Checking membership…": "মেম্বারশিপ চেক হচ্ছে…",
    "Channel link not set": "চ্যানেল লিংক সেট নেই",
    "Already completed": "ইতিমধ্যে সম্পন্ন",
    "Adult library is currently unavailable.": "অ্যাডাল্ট লাইব্রেরি এখন উপলব্ধ নয়।",
    "No file chosen": "কোনো ফাইল বাছা হয়নি",
    "Choose File": "ফাইল বেছে নিন",
    "Your choice is remembered for this session only": "আপনার পছন্দ শুধু এই সেশনের জন্য মনে রাখা হবে",
    "I confirm that I am 18 or older": "আমি নিশ্চিত করছি আমার বয়স ১৮ বা তার বেশি",
    "Reload": "রিলোড",
    "Loading content…": "কনটেন্ট লোড হচ্ছে…",
    "Boot error": "বুট এরর",
    "Page error": "পেজ এরর",
    "Next": "পরের",
    "Previous": "আগের",
    ...
    "Link": "লিংক",
    "ID missing": "আইডি পাওয়া যায়নি",
    "Link empty — set Mini App link in Admin → Settings": "লিংক খালি — অ্যাডমিন → Settings এ Mini App লিংক দিন",
    "Movie not found": "মুভি পাওয়া যায়নি",
    "Copy error": "কপি এরর",
    "Share error": "শেয়ার এরর",
    "We're updating the app right now. Please check back soon.": "অ্যাপ আপডেট হচ্ছে। একটু পরে আবার চেষ্টা করুন।",
    "Watch / Download now": "এখনই দেখুন / ডাউনলোড করুন",
    "To watch this movie, tap Watch / Download below": "মুভিটি দেখতে নিচে Watch / Download বাটনে ক্লিক করুন",
    "To watch this adult content, tap Watch / Download below": "এই এডাল্ট কনটেন্ট দেখতে নিচে Watch / Download বাটনে ক্লিক করুন",

    "Payment request limit reached ({n} per {h}h). Try again later.": "পেমেন্ট রিকোয়েস্ট লিমিট শেষ ({n} বার / {h} ঘণ্টা)। পরে আবার চেষ্টা করুন।",
    "Daily payment request limit reached ({n} per day). Try again after midnight.": "আজকের পেমেন্ট রিকোয়েস্ট লিমিট শেষ ({n} বার / দিন)। রাত ১২টার পর আবার চেষ্টা করুন।",
    "Payment save failed": "পেমেন্ট সেভ হয়নি",
    "Payment save failed: Firebase API missing": "পেমেন্ট সেভ হয়নি: Firebase API নেই",
